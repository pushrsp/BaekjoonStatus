...
class MemberRepositoryTest extends IntegrationTestSupport {
    ...
    public void can_find_member_by_member_id() throws Exception {
        ...
        //when
        Optional<Member> optionalMember = memberRepository.findById(Long.parseLong(savedMember.getId()));
    ...
    public void can_find_members_who_has_greater_member_id_than_given_member_id() throws Exception {
        ...
        //when
        List<Member> m1 = memberRepository.findAllGreaterThanMemberId(0L, 10);
        List<Member> m2 = memberRepository.findAllGreaterThanMemberId(18L, 10);
        List<Member> m3 = memberRepository.findAllGreaterThanMemberId(20L, 10);

        //then
        assertThat(m1).hasSize(10);
        assertThat(m2).hasSize(2);
        assertThat(m3).hasSize(0);
    }
